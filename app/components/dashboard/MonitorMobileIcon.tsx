...
type MonitorMobileIconProps = SVGProps<SVGSVGElement>

export const MonitorMobileIcon: React.FC<MonitorMobileIconProps> = props => (
  <svg
    aria-hidden='true'
    fill='none'
    focusable='false'
...
export const ShieldSecurityIcon: React.FC<MonitorMobileIconProps> = props => (
  <svg
    aria-hidden='true'
    fill='none'
    focusable='false'
...
export const InfoIcon: React.FC<MonitorMobileIconProps> = props => (
  <svg
    aria-hidden='true'
    fill='none'
    focusable='false'
...
export const InvalidCardIcon: React.FC<MonitorMobileIconProps> = props => (
  <svg
    aria-hidden='true'
    fill='none'
    focusable='false'
